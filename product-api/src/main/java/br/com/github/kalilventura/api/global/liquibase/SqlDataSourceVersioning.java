...
public class SqlDataSourceVersioning {
    ...
    protected SpringLiquibase generateSpringLiquibase(
        ...
        final var dataSourceName = SqlDataSourceHelper.getNameByUrl(((HikariDataSource) dataSource).getJdbcUrl());
    ...
    private Liquibase generateLiquibase(final SpringLiquibase springLiquibase) {
        ...
        return new Liquibase(springLiquibase.getChangeLog(), new ClassLoaderResourceAccessor(), database);
    }
