...
class FindAllCategoriesCommandTest {
    ...
    void onSuccess() {
        ...
        final var listeners = new FindAllCategoriesCommand.Listeners(MockitoHelper.mockConsumer(), null);
    ...
    void onEmpty() {
        ...
        final var command = new FindAllCategoriesCommand(service);
        final var listeners = new FindAllCategoriesCommand.Listeners(null, MockitoHelper.mockRunnable());
