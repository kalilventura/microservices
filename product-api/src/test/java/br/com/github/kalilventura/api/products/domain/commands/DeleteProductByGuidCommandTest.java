...
class DeleteProductByGuidCommandTest {
    ...
    void shouldCallOnSuccess() {
        ...
        final var listeners = new DeleteProductByGuidCommand.Listeners(MockitoHelper.mockRunnable(), null);
    ...
    void shouldCallOnEmpty() {
        ...
        final var command = new DeleteProductByGuidCommand(service, getService);
        final var listeners = new DeleteProductByGuidCommand.Listeners(null, MockitoHelper.mockRunnable());
