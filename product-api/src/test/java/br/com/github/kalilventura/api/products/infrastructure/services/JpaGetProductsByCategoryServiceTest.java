...
class JpaGetProductsByCategoryServiceTest {
  ...
  void getProductsByCategorySuccessfully() {
    ...
    final var category = new JpaCategoryBuilder().withGuid(categoryGuid).buildDefault();

    final var products = new JpaProductBuilder().withCategory(category).buildMany(10);
